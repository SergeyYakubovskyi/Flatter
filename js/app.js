 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                function updateValuePosition() {
                    ...
                    yearsValue.textContent = `${value} Years`;
                    const handleElement = priceSlider.querySelector(".noUi-handle");
                    const handleRect = handleElement.getBoundingClientRect();
                    const sliderRect = priceSlider.getBoundingClientRect();
                    const handlePosition = handleRect.left - sliderRect.left + handleRect.width / 2;
                    yearsValue.style.left = `${handlePosition}px`;
                }
                priceSlider.noUiSlider.on("update", updateValuePosition);
        ...
        function initSliders() {
            if (document.querySelector(".journey__slider")) new swiper_core_Swiper(".journey__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
...
*/
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.from(".hero__title .title__element", {
                duration: 1,
                opacity: 0,
                y: -50,
                stagger: .2,
            ...
            gsapWithCSS.from(".hero__column--black ", {
                duration: 1.2,
                opacity: 0,
                delay: .7,
                x: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".hero__column--black",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".hero__column--black .hero__title", {
                duration: 1,
                opacity: 0,
                x: -100,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".hero__column--black .hero__title",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            gsapWithCSS.from(".start__image", {
                duration: 1,
                opacity: 0,
                scale: .8,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".start__image",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".start__form", {
                duration: 1,
                opacity: 0,
                x: -100,
                ease: "power2.out",
            ...
            gsapWithCSS.from(".start__arrow ", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".start__arrow",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".start__title", {
                duration: 1,
                opacity: 0,
                x: 50,
                ease: "power2.out",
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
            gsapWithCSS.from(".journey__top-block", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".journey__top-block",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".journey__slide", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                stagger: .2,
                scrollTrigger: {
                    trigger: ".journey__slider",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".journey__btn-prev", {
                duration: 1,
                opacity: 0,
                x: -50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".journey__btn-prev",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
            gsapWithCSS.from(".popular__top-block", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".popular__top-block",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".card__body", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                stagger: .2,
                scrollTrigger: {
                    trigger: ".popular__middle",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".bottom-pop__title", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".bottom-pop__title",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".bottom-pop__button", {
                duration: 1,
                opacity: 0,
                scale: .8,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".bottom-pop__button",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
            gsapWithCSS.from(".estimate__top-block", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".estimate__top-block",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".inner-content__body--dark form", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                stagger: .2,
                scrollTrigger: {
                    trigger: ".inner-content__body--dark",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".inner-white__top", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".inner-white__top",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".inner-white__middle", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".inner-white__middle",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".inner-white__bottom", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".inner-white__bottom",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
            gsapWithCSS.from(".about__top-block", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".about__top-block",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".achivmant__arrow-def, .achivmant__arrow", {
                duration: 1,
                opacity: 0,
                scale: .8,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".achivmant__arrows",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".achivmant__image", {
                duration: 1,
                opacity: 0,
                x: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".achivmant__image",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
            gsapWithCSS.from(".service-area__top-block", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".service-area__top-block",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
            gsapWithCSS.from(".reviews__top", {
                duration: 1,
                opacity: 0,
                y: 50,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".reviews__top",
                    start: "top 80%",
                    toggleActions: "play none none none"
                }
            });
            gsapWithCSS.from(".reviews__slide", {
                duration: 1,
                opacity: 0,
                delay: .5,
                y: 50,
            ...
            gsapWithCSS.from(".reviews__btn-prev, .reviews__btn-next", {
                duration: 1,
                opacity: 0,
                delay: 1,
                x: 50,
